...
def install_desktop() -> None:
    ...
    # hyprland
    install(BASEDIR / "hypr" / "hyprland.lua", CONFIG_HOME / "hypr" / "hyprland.lua")
    install(BASEDIR / "hypr" / "kanagawa-dragon.lua", CONFIG_HOME / "hypr" / "kanagawa-dragon.lua")
    ...
    # for Niri
    install_service("waybar-niri.service")
